...
<div id="formProd" class="cadre">
  <f:form modelAttribute="produit" action="saveProd" method="post" enctype="multipart/form-data"> <!-- enctype pour faire upload (envoyer une image) -->
    <table>
    ...
    <tr>
     ...
     <td><f:errors path="" cssClass="errors"></f:errors></td>
    </tr>
    <tr>
     <td>Description : </td>
    ...
    <tr>
     ...
     <td>
       <c:if test="${produit.idProduit != null }">
         <img src="photoProd?idProd=${produit.idProduit }"></img>
       </c:if>
     </td>
      <td><f:input cssClass="cacher"  path="photo"/></td>
...
<div id="tabCategories" class="cadre">
 <table class="tab1">
  <tr>
   <th>ID </th><th>Désignation </th><th>Description </th><th>Catégorie </th><th>Prix </th><th>Quantité </th><th>Selected </th><th>Photo </th>
  </tr>
  ...
  <tr>
   ...
   <td>${p.quantite }</td>
   <td>${p.selected }</td>
   <td><img src="photoProd?idProd=${p.idProduit }"></img></td>
